...
// checks if the TimelineComment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimelineComment{}
...
func (o *TimelineComment) GetDependentIssue() Issue {
	if o == nil || IsNil(o.DependentIssue) {
		var ret Issue
		return ret
	}
...
func (o *TimelineComment) GetRemovedAssignee() bool {
	if o == nil || IsNil(o.RemovedAssignee) {
		var ret bool
		return ret
	}
...
func (o TimelineComment) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Assignee) {
		toSerialize["assignee"] = o.Assignee
	}
	if !IsNil(o.AssigneeTeam) {
	...
	if !IsNil(o.OldMilestone) {
		toSerialize["old_milestone"] = o.OldMilestone
	}
	if !IsNil(o.OldProjectId) {
