...
// checks if the GeneralUISettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeneralUISettings{}
...
func (o *GeneralUISettings) GetAllowedReactions() []string {
	if o == nil || IsNil(o.AllowedReactions) {
		var ret []string
		return ret
	}
...
func (o GeneralUISettings) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AllowedReactions) {
		toSerialize["allowed_reactions"] = o.AllowedReactions
	}
	if !IsNil(o.CustomEmojis) {
