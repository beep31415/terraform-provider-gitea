...
// checks if the CommitDateOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommitDateOptions{}
...
func (o CommitDateOptions) ToMap() (map[string]interface{}, error) {
