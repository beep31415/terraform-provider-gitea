...
// checks if the CreateKeyOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateKeyOption{}
...
func (o CreateKeyOption) ToMap() (map[string]interface{}, error) {
