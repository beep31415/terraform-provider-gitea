...
// checks if the CreateOAuth2ApplicationOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOAuth2ApplicationOptions{}
...
func (o CreateOAuth2ApplicationOptions) ToMap() (map[string]interface{}, error) {
