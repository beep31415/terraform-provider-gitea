...
// checks if the EditOrgOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditOrgOption{}
...
func (o EditOrgOption) ToMap() (map[string]interface{}, error) {
