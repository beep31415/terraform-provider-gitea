...
// checks if the EditBranchProtectionOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditBranchProtectionOption{}
...
func (o EditBranchProtectionOption) ToMap() (map[string]interface{}, error) {
