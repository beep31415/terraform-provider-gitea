...
// checks if the ServerVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerVersion{}
...
func (o ServerVersion) ToMap() (map[string]interface{}, error) {
