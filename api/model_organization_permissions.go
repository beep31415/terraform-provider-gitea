...
// checks if the OrganizationPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationPermissions{}
...
func (o *OrganizationPermissions) GetCanCreateRepository() bool {
	if o == nil || IsNil(o.CanCreateRepository) {
		var ret bool
		return ret
	}
...
func (o OrganizationPermissions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CanCreateRepository) {
