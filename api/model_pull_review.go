...
// checks if the PullReview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PullReview{}
...
func (o PullReview) ToMap() (map[string]interface{}, error) {
