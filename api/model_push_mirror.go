...
func (o *PushMirror) GetCreated() string {
...
func (o *PushMirror) GetCreatedOk() (*string, bool) {
	if o == nil || IsNil(o.Created) {
		return nil, false
	}
...
func (o *PushMirror) SetCreated(v string) {
	o.Created = &v
}
...
func (o *PushMirror) GetLastUpdate() string {
...
// and a boolean to check if the value has been set.
func (o *PushMirror) GetLastUpdateOk() (*string, bool) {
	if o == nil || IsNil(o.LastUpdate) {
		return nil, false
	}
...
func (o *PushMirror) SetLastUpdate(v string) {
	o.LastUpdate = &v
}
