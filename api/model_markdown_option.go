...
// checks if the MarkdownOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarkdownOption{}
...
func (o MarkdownOption) ToMap() (map[string]interface{}, error) {
