...
// checks if the CreateFileOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFileOptions{}
...
func (o CreateFileOptions) ToMap() (map[string]interface{}, error) {
