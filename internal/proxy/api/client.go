...
// APIClient manages communication with the Gitea API. API v1.20.0+dev-833-g040970c32
...
type APIClient struct {
	...
	ActivitypubAPI *ActivitypubAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ActivitypubAPI = (*ActivitypubAPIService)(&c.common)
