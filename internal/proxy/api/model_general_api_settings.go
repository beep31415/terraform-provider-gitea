...
// checks if the GeneralAPISettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeneralAPISettings{}
...
func (o *GeneralAPISettings) GetDefaultGitTreesPerPage() int64 {
	if o == nil || IsNil(o.DefaultGitTreesPerPage) {
		var ret int64
		return ret
	}
...
func (o *GeneralAPISettings) GetDefaultMaxBlobSize() int64 {
	if o == nil || IsNil(o.DefaultMaxBlobSize) {
		var ret int64
		return ret
	}
...
func (o *GeneralAPISettings) GetDefaultPagingNum() int64 {
	if o == nil || IsNil(o.DefaultPagingNum) {
		var ret int64
		return ret
	}
...
func (o *GeneralAPISettings) GetMaxResponseItems() int64 {
	if o == nil || IsNil(o.MaxResponseItems) {
		var ret int64
		return ret
	}
...
func (o GeneralAPISettings) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DefaultGitTreesPerPage) {
		toSerialize["default_git_trees_per_page"] = o.DefaultGitTreesPerPage
	}
	if !IsNil(o.DefaultMaxBlobSize) {
		toSerialize["default_max_blob_size"] = o.DefaultMaxBlobSize
	}
	if !IsNil(o.DefaultPagingNum) {
		toSerialize["default_paging_num"] = o.DefaultPagingNum
	}
	if !IsNil(o.MaxResponseItems) {
