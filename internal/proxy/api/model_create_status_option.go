...
// checks if the CreateStatusOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateStatusOption{}
...
func (o CreateStatusOption) ToMap() (map[string]interface{}, error) {
